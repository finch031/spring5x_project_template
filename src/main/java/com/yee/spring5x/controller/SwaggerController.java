...
import com.yee.spring5x.entity.User;
...
public class SwaggerController {
    ...
    public String postTest3(@ApiParam(value = "name参数说明", defaultValue = "post-name的默认值") @RequestBody User user) {
        System.out.println("post-demoEntity= " + user);
        return "这是postTest3";
    }
